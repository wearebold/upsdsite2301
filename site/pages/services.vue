<template>
      ...
      <article class="l-container">
        <PageHeader headerText="Services" subHeaderText="& Maintenance"></PageHeader>             
        <section class="grid grid-cols-1 l-grid-line l-grid-line--t md:grid-cols-12 | relative bg-gray-100 gap-px pt-px px-px">
          <div class="hidden md:block md:col-span-2 bg-white">
            ...
            <div class="aspect-[2/1] bg-b-bronze-500"></div>                     -->
          </div>
          <div class="md:col-span-10 bg-white p-4" style="padding: var(--space-l-xl);">
            <div class="prose max-w-prose mx-auto">            
              <h2 class="text-h2">Heading</h2>              
              <p class="text-h5">Coupled with our extensive range of market-leading products, we offer a line of services ranging from installation of generators to real-time status monitoring and maintenance.</p>
            </div>
          </div>

        </section>

        <section class="grid grid-cols-1 l-grid-line l-grid-line--t md:grid-cols-12 | relative bg-gray-100 gap-y-px pt-px px-px">
          
          <div class="md:col-span-6 bg-gray-100 p-4" style="padding: var(--space-l-xl);">
            <div class="prose">
            <h3 class="text-h1">Consultancy</h3>      
            </div>

          </div>

          <div class="md:col-span-6 bg-white p-4" style="padding: var(--space-l-xl);">
              <div class="prose max-w-prose mx-auto">            
                <p class="text-h5">Aside from our diverse range of products, we are able to offer the services of our vastly experienced engineers and technicians for consultancy roles.</p>
        ...
        <section class="grid grid-cols-1 l-grid-line l-grid-line--t md:grid-cols-12 | relative bg-gray-100 gap-y-px pt-px px-px">
          ...
          <div class="md:col-span-6 bg-white p-4" style="padding: var(--space-l-xl);">
            <div class="prose">
            <h3 class="text-h1">Installation Services</h3>      
            </div>
          ...
          <div class="md:col-span-6 bg-white p-4" style="padding: var(--space-l-xl);">
              <div class="prose max-w-prose mx-auto">            
                <p class="text-h5">As part of our complete solutions packages, our team of experienced engineers carry out all installations of our products and services.</p>
        ...
        <section class="grid grid-cols-1 l-grid-line l-grid-line--t md:grid-cols-12 | relative bg-gray-100 gap-y-px pt-px px-px">
          ...
          <div class="md:col-span-6 bg-gray-100 p-4" style="padding: var(--space-l-xl);">
            <div class="prose">
            <h3 class="text-h1">Computer Room Build</h3>      
            </div>
          ...
          <div class="md:col-span-6 bg-white p-4" style="padding: var(--space-l-xl);">
              <div class="prose max-w-prose mx-auto">            
                <p class="text-h5">Installation of power protection equipment often leads to the alteration and/or upgrading of allied building services. Because of this, UPS Direct Ltd has the skill base to provide the following additional services:</p>
        ...
        <section class="grid grid-cols-1 l-grid-line l-grid-line--t md:grid-cols-12 | relative bg-gray-100 gap-y-px pt-px px-px">
          ...
          <div class="md:col-span-6 bg-white p-4" style="padding: var(--space-l-xl);">
            <div class="prose">
            <h3 class="text-h1">Maintenance</h3>      
            </div>
          ...
          <div class="md:col-span-6 bg-white p-4" style="padding: var(--space-l-xl);">
              <div class="prose max-w-prose mx-auto">            
                <p class="text-h5">Like any other computer peripheral, reliability and efficiency is directly linked to maintenance. The only difference is that the failure of most peripheral devices is usually only an annoyance.....the failure of your UPS can replicate the one disaster it was intended to prevent.</p>
        ...
        <section class="grid grid-cols-1 l-grid-line l-grid-line--t md:grid-cols-12 | relative bg-gray-100 gap-y-px pt-px px-px">
          ...
          <div class="md:col-span-6 bg-gray-100 p-4" style="padding: var(--space-l-xl);">
            <div class="prose">
            <h3 class="text-h1">Battery Servicing</h3>      
            </div>
          ...
          <div class="md:col-span-6 bg-white p-4" style="padding: var(--space-l-xl);">
              <div class="prose max-w-prose mx-auto">            
                <p class="text-h5">All UPS's rely on an internal battery. Like any other battery, it is a consumable item which will demonstrate its health (or lack of) when it is put into use.</p>
        ...
        <section class="grid grid-cols-1 l-grid-line l-grid-line--t md:grid-cols-12 | relative bg-gray-100 gap-y-px pt-px px-px">
          ...
          <div class="md:col-span-6 bg-white p-4" style="padding: var(--space-l-xl);">
            <div class="prose">
            <h3 class="text-h1">Maintenance Contracts</h3>      
            </div>
          ...
          <div class="md:col-span-6 bg-white p-4" style="padding: var(--space-l-xl);">
              <div class="prose max-w-prose mx-auto">            
                <p class="text-h5">While all of our work is guaranteed for twelve months from completion, we can offer 'total' maintenance contracts for the whole of your installation. This service is available for most equipment, whether installed by us, or by others.</p>
                <p>We can offer a more cost-effective and thorough solution because we assess your site as a whole and can identify potential imbalances between equipment types before they occur. Linked with infrared thermal scanning, we aim to keep your business running without costly, unscheduled downtime</p>
            </div>
          </div>
