      ...
      <article class="l-container">
        <header class="grid grid-cols-1 l-grid-line l-grid-line--t md:grid-cols-12 | relative bg-gray-100 gap-px pt-px px-px">
          ...
          <div class="md:col-span-10 bg-b-blue-500 text-white" style="padding: var(--space-xs);">
            <h1 class="text-h1 font-medium leading-tight tracking-wide">Customised Solutions</h1>
          </div>
        </header>
        <section class="grid grid-cols-1 l-grid-line l-grid-line--t md:grid-cols-12 | relative bg-gray-100 gap-px pt-px px-px">
          ...
          <div class="md:col-span-10 bg-white p-4" style="padding: var(--space-l-xl);">
            ...
            <p class="text-h5">Off the shelf UPS’s are designed for use within a climate controlled environment such as an office or server room. The reason:- UPS systems are unique in that they combine both micro-electronics and high power components in a single cabinet.</p>
...
<p>Our customised solutions are also used in various manufacturing plants ranging from yoghurt production to egg packaging to aircraft braking systems test rigs.</p>
          </div>
