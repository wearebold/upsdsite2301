        ...
        <div class="md:col-span-10 bg-white p-4 relative flex justify-center">
          ...
          >
            <ul class="links flex flex-col gap-6 | md:flex-row">
              ...
              <li class="link">
                <NuxtLink to="/services"  @click="clearState">Services</NuxtLink>
              </li>
              <li class="link">
                <NuxtLink to="/products"  @click="clearState">Products</NuxtLink>
              </li>
              <li class="link">
              ...
              <li class="link">
                <NuxtLink to="/case-studies"  @click="clearState">Case Studies</NuxtLink>
              </li>
              <li class="link">
...
.site-header {
  @apply sticky top-0 w-full z-20;
}
